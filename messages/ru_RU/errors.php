...
return array(
	...
	'Unknown field type for column {column}' => 'Неизвестное имя для поля {column}',
	'The PrimaryKey "{fieldName}" value absents in the selection row' => 'PrimaryKey «{fieldName}» отсутствует в строке выборки',
	'ENUM values must be set for the field {fieldName}' => 'Значения ENUM должны быть заданы для поля {fieldName}',
	'The parameter "directoryPath" must be set for the field {fieldName}' => 'Параметр directoryPath должен быть установлен для поля {fieldName}',
	...
	'The field "{field}" cannot be NULL but it can be passed by the form' => 'Поле {field} не может быть NULL, однако иные данные из формы переданы не были',
